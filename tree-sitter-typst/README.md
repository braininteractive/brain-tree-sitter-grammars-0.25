# tree-sitter-typst (fork)

> **Provenance (fork):** forked from <https://github.com/uben0/tree-sitter-typst>
> (commit `46cf4ded12ee974a70bf8457263b67ad7ee0379d`, 2025-02-10).
> **Changes vs upstream:** ABI 14 -> 15 regen; legacy binding rewritten to LanguageFn.
> Corpus is machine-imported from the typst compiler reference tests: 2840/2934 (96.8%)
> — the 94 deviations are pre-existing upstream edge cases (regen is behavior-
> identical), e.g. emph-at-parbreak, terms-missing-colon; added a synthetic smoke-test
> corpus (test/corpus_smoke/, 10 files) and tests/smoke.rs. Upstream corpus: 2840/2934
> (documented); smoke corpus: 0.00% error nodes under the cargo <5% gate.
