// ------------------------------------------------------------------------------------------------
// Copyright © 2023 Amaan Qureshi <amaanq12@gmail.com>, Campbell He <kp.campbell.he@duskmoon314.com>
...
//! let language = tree_sitter_thrift::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading Thrift parser");
...
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_thrift) };
