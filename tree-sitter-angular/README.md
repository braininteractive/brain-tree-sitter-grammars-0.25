# tree-sitter-angular (fork)

> **Provenance (fork):** forked from <https://github.com/dlvandenberg/tree-sitter-angular>
> (commit `38a8014ed5452cd6b7cf1399c00177a1f5374256`, 2026-05-15).
> **Changes vs upstream:** legacy language() binding rewritten to LanguageFn; version
> aligned to 0.25.0. Covers interpolation, property/event/two-way bindings, structural
> directives, and the Angular 17+ control-flow blocks (@if/@for/@switch/@defer/@let);
> added a synthetic smoke-test corpus (test/corpus_smoke/, 10 files) and tests/smoke.rs.
> Upstream corpus: 146/146; smoke corpus: 0.00% error nodes under the cargo <5% gate.
