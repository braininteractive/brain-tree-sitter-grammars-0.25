...
//! parser.set_language(&tree_sitter_move_on_aptos::LANGUAGE.into()).expect("Error loading MoveOnAptos grammar");
...
extern "C" {
    fn tree_sitter_move_on_aptos() -> *const ();
}

/// The tree-sitter [`LanguageFn`][LanguageFn] for this grammar.
///
/// [LanguageFn]: https://docs.rs/tree-sitter-language/*/tree_sitter_language/struct.LanguageFn.html
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_move_on_aptos) };
