...
> **Provenance (fork):** forked from <https://github.com/aptos-labs/tree-sitter-move-on-aptos>
> (commit `12906b3`, 2026-02-17).
...
> crate version set to `0.25.0`; `parser.c` regenerated with tree-sitter-cli 0.25.10
> (ABI 15); added a synthetic smoke-test corpus (`test/corpus_smoke/`, 12 files) and
> `tests/smoke.rs`. No grammar-rule changes. Dialect: **Move on Aptos** (Move 2:
> enums, `match`, spec language, attributes).
