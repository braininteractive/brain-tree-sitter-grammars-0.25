# tree-sitter-just (fork)

> **Provenance (fork):** forked from <https://github.com/IndianBoy42/tree-sitter-just>
> (commit `5685543a6e64f66335e25518c9ae8ffa1dae3d01`, 2026-03-25).
> **Changes vs upstream:** pin-style — already ABI 15 + LanguageFn (scanner kept
> verbatim); version aligned to 0.25.0; added a synthetic smoke-test corpus
> (test/corpus_smoke/, 10 files) and tests/smoke.rs. Upstream corpus: 71/71; smoke
