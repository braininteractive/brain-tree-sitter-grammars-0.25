...
fn expected_top_level_node_kinds_are_present() {
    ...
    // Kinds picked from src/node-types.json that map onto jsonnet's
    // real-world surface: bindings, functions, comprehensions, imports,
    // conditionals, objects, and asserts.
    let expected = [
        "local_bind",
        "bind",
        "anonymous_function",
