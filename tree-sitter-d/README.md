...
> **Provenance (fork):** forked from <https://github.com/gdamore/tree-sitter-d>
> (commit `64f2793`, 2026-06-19).
> **Changes vs upstream:** parser.c regenerated with CLI 0.25.10 (ABI 14 -> 15); added
> tree-sitter.json (required by CLI 0.25); added missing tree-sitter dev-dependency;
> version aligned to 0.25.0. External C scanner kept verbatim; added a synthetic smoke-
> test corpus (test/corpus_smoke/, 10+ files) and tests/smoke.rs. Package name `tree-
> sitter-d` kept verbatim. Upstream corpus: 223/223; smoke corpus: 0.00% error nodes
