# tree-sitter-fsharp (fork)

> **Provenance (fork):** forked from <https://github.com/ionide/tree-sitter-fsharp>
> (commit `789d8ea`, 2026-07-30).
> **Changes vs upstream:** pin-style dual grammar (LANGUAGE_FSHARP / LANGUAGE_SIGNATURE)
> — already ABI 15 + LanguageFn; version aligned to 0.25.0, dev-dep pinned 0.25; added a
> synthetic smoke-test corpus (test/corpus_smoke/, 10+ files) and tests/smoke.rs.
> Package name `tree-sitter-fsharp` kept verbatim. Upstream corpus: 529/529; smoke
