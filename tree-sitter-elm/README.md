# tree-sitter-elm (fork)

> **Provenance (fork):** forked from <https://github.com/elm-tooling/tree-sitter-elm>
> (commit `e1e8fea`, 2026-07-20).
...
> 10+ files) and tests/smoke.rs. Package name `tree-sitter-elm` kept verbatim. Upstream
> corpus: 120/120; smoke corpus: 0.00% error nodes under the cargo <5% gate.
